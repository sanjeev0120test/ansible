#!/bin/bash
# Run inside WSL: bash scripts/run_create_users_wsl.sh
# Legacy playbook runner — prefer configure_managed_identity.yml + .env
set -e
...
ansible-playbook -i inventory/hosts.autogen.yml playbooks/create_linux_users.yml \
